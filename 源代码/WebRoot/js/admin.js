		       ...
		       text: "学校管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    url: "School/school_add.jsp"
			    	   	},
			    		{
			    	   		text: "学校管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "School/school_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "项目管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Project/project_add.jsp"
			    	   	},
			    		{
			    	   		text: "项目管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Project/project_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "比赛管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Contest/contest_add.jsp"
			    	   	},
			    		{
			    	   		text: "比赛管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Contest/contest_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "报名学生管理",
		       ...
		       text: "比赛成绩管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Score/score_add.jsp"
			    	   	},
			    		{
			    	   		text: "比赛成绩管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Score/score_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻公告管理",
