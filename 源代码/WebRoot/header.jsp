        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>School/frontlist">参赛学校</a></li>
                <li><a href="<%=basePath %>Project/frontlist">比赛项目</a></li>
                <li><a href="<%=basePath %>Contest/frontlist">比赛信息</a></li>
                <li><a href="<%=basePath %>Student/frontlist">学生风采</a></li>
                <li><a href="<%=basePath %>Score/frontlist">成绩公布</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Student/student_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;报名注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Contest/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我报名的比赛</a></li>
                        <li><a href="<%=basePath %>Score/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的成绩积分</a></li> 
                        <li><a href="<%=basePath %>Student/student_frontModify.jsp?user_name=<%=session.getAttribute("user_name") %>"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
